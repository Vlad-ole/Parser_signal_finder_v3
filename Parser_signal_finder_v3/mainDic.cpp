//
// File generated by rootcint at Mon May 27 12:18:31 2019
...
static int G__mainDic_249_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
     p = new EventMainCh((unsigned int) G__int(libp->para[0]));
   } else {
     p = new((void*) gvp) EventMainCh((unsigned int) G__int(libp->para[0]));
   }
...
static void G__setup_memfuncEventMainCh(void) {
   ...
   G__memfunc_setup("EventMainCh",1074,G__mainDic_249_0_1, 105, G__get_linked_tagnum(&G__mainDicLN_EventMainCh), -1, 0, 1, 1, 1, 0, "h - - 0 - number_of_channels", (char*)NULL, (void*) NULL, 0);
...
extern "C" void G__cpp_setup_tagtablemainDic() {
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__mainDicLN_EventMainCh),sizeof(EventMainCh),-1,62464,(char*)NULL,G__setup_memvarEventMainCh,G__setup_memfuncEventMainCh);
